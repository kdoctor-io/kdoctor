...
var _ = Describe("testing netReach ", Label("netReach"), func() {
	...
	It("success testing netReach", Label("B00001", "C00004", "E00013", "E00016"), Serial, func() {
		var e error
		crontab := "0 1"
	...
	It("Successfully testing Task NetReach Runtime DaemonSet Service Ingress creation ", Label("E00001"), Serial, func() {
		var e error
		crontab := "0 1"
		netReachName := "netreach-" + tools.RandomName()
