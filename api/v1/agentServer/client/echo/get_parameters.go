...
// WithTask adds the task to the get params
func (o *GetParams) WithTask(task *string) *GetParams {
	o.SetTask(task)
	return o
}

// SetTask adds the task to the get params
func (o *GetParams) SetTask(task *string) {
	o.Task = task
}
